...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      quote: "I've been asking cousins for family stories for years. With RootLink, my family actually wants to share. We've discovered stories we never knew existed.",
      image: '👩',
    },
    {
      name: 'James K.',
      relation: 'Grandpa',
      quote: 'Building a family tree used to mean hours on Excel. This just works. My grandkids finally understand where we come from.',
      image: '👨‍🦳',
    },
    {
      name: 'Amita L.',
      relation: 'Global family',
      quote: "We're spread across four countries. RootLink keeps us connected in a way Facebook never did. My kids know their cousins again.",
      image: '👩‍👧',
    },
    {
      name: 'Michael T.',
      relation: 'Family reunion organizer',
      quote: "Before reunions, I manually track who's coming. Now everyone's already connected. It's made planning so much easier.",
      image: '👨',
    },
  ];
  ...
  const steps = [
    {
      ...
      description: 'Sign up with your email and add your basic info. Takes 2 minutes.',
    },
    {
      number: '2',
      title: 'Build or import your tree',
      description: 'Manually add family members or invite relatives directly. They confirm and your tree grows.',
    },
    {
      number: '3',
      title: 'Start sharing stories',
      description: 'Write memories, share photos, and connect with relatives. Your family history stays alive.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold text-gray-900">RootLink</span>
          </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Build your multi-generational family tree, share stories with relatives, and discover connections that matter. No more lost memories. No more missing relatives.
              </p>
            ...
            <div className="hidden lg:block">
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 aspect-square flex items-center justify-center">
                <div className="text-center">
                  <TreePine className="w-24 h-24 text-emerald-600/30 mx-auto mb-4" />
                  <p className="text-gray-600 font-medium">Your family tree in one place</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-12 border-t border-gray-200">
            <p className="text-center text-sm text-gray-500 mb-4">Why families trust RootLink</p>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-600 mt-12">
            💡 <span className="font-medium">Pro tip:</span> Start with your immediate family. You can add more people and branches anytime.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              <details key={i} className="bg-white p-6 rounded-lg border border-gray-200 group">
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join 2,000+ families keeping their heritage alive. A quick demo shows you exactly how it works.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-600">Keeping families connected across generations.</p>
            </div>
